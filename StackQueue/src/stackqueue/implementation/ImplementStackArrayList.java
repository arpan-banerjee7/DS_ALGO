...
public class ImplementStackArrayList<T> {
	...
	// To initialize stack
	ImplementStackArrayList(int size) {
	...
	public static void main(String[] args) {
		...
		ImplementStackArrayList<Integer> s1 = new ImplementStackArrayList<>(3);
		...
		// Creating an object of Stack class
		// Declaring objects of Integer type
		ImplementStackArrayList<String> s2 = new ImplementStackArrayList<>(3);
